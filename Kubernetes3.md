...
- 설치확인
![image](./image/kubernetes3/1.png)<br/>
![image](./image/kubernetes3/2.png)<br/>
프로미스 서비스의 설정을 바꿔준다.<br/>

![image](./image/kubernetes3/3.png)<br/>
...
- 그라파나 모니터링 탬플릿 불러오기
![image](./image/kubernetes3/4.png)<br/>
![image](./image/kubernetes3/5.png)<br/>
![image](./image/kubernetes3/6.png)<br/>
![image](./image/kubernetes3/7.png)<br/>
