...
- 확인
![image](./image/prometheus/19.png)<br/>
...
- 1분 후 
![image](./image/prometheus/20.png)<br/>
![image](./image/prometheus/21.png)<br/>

test02에 메일이 온다.<br/>


- Gmail로 받아보기
![image](./image/prometheus/18.png)<br/>
![image](./image/prometheus/22.png)<br/>
두개가 설정이 완료되야 한다.<br/>
...
systemctl restart prometheus alertmanager
```
![image](./image/prometheus/23.png)<br/>
